        ...
        <form action=<?= base_url("Tugas_uts/cetak"); ?> method="post">
            <table>
                ...
                <tr>
                    ...
                    <th>:</th>
                    <td>
                        <input type="date" name="tanggal" id="tanggal" value="<?= set_value('tanggal') ?>">
                    </td>
                </tr>
                <tr>
                    <th>
                        <h6>(Format : 23-04-2022)</h6>
                    </th>
                    <th></th>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <select name="agama" id="agama">
                            <option value="0" <?php echo set_select('Agama', 'Pilih Agama', TRUE); ?>>Pilih Agama</option>
                            ...
                            <option value="Kristen" <?php echo set_select('Agama', 'Kristen', (!empty($this->input->post('agama') && $this->input->post('agama') == 'Kristen' ? TRUE : FALSE))); ?>>Protestan</option>
                            <option value="Katolik" <?php echo set_select('Agama', 'Katolik', (!empty($this->input->post('agama') && $this->input->post('agama') == 'Katolik' ? TRUE : FALSE))); ?>>Katholik</option>
